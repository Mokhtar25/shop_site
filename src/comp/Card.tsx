...
const Card = ({
  ...
  return (
    <div className="group relative flex h-72 w-52 cursor-pointer flex-col items-center justify-between rounded border-2 border-white p-4 before:absolute before:bottom-0 before:-z-30 before:h-[40%] before:w-full before:bg-pink-400 before:content-['']">
      <img
...
const HeartIcon = ({ className, active, onClick, ...props }: IconProps) => (
  <svg
    ...
    viewBox="0 0 24 24"
    className={(active ? "fill-red-700 " : "fill-white ") + className}
    {...props}
  >
